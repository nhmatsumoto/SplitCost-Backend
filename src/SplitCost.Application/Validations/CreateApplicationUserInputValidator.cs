...
public class CreateApplicationUserInputValidator : AbstractValidator<CreateUserInput>
{
    ...
    {
        return !await _userRepository.ExistsAsync(x => x.Username == username, ct);
    }

    private async Task<bool> BeUniqueEmail(string email, CancellationToken ct)
    {
        return !await _userRepository.ExistsAsync(x => x.Email == email, ct);
    }
}
