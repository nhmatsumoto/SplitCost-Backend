...
public class CreateExpenseUseCase(
    ...
    IMapper mapper,
    IValidator<CreateExpenseInput> validator) : IUseCase<CreateExpenseInput, Result<CreateExpenseOutput>>
{
    ...
    private readonly IValidator<CreateExpenseInput> _validator          = validator             ?? throw new ArgumentNullException(nameof(validator));
